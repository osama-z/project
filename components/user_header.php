    ...
    <nav class="navbar nav-1">
        <section class="flex">
            <a href="home.php" class="logo">
                <i class="fas fa-house"></i> Real Estates
            </a>
            ...
            <div class="menu">
                <ul>
                    <li>
                        <a href="#">My Listings <i class="fas fa-angle-down"></i></a>
                        <ul>
                    ...
                    <li>
                        <a href="#">Options <i class="fas fa-angle-down"></i></a>
                        <ul>
                    ...
                    <li>
                        <a href="saved.php">Saved <i class="far fa-heart"></i></a>
                    </li>
                    <li>
